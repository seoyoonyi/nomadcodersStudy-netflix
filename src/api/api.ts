...
export const isMovie = (data: IMovie | IShow): data is IMovie => {
...
export const getGenreMovies = (genreId: number) => {
  return fetch(
...
export const getGenreShows = (genreId: number) => {
  return fetch(
